# JavaFX Tutorial Part 2 - Creating a GUI for Togepi.Duke

In this tutorial, we will be creating a GUI for Togepi.Duke from scratch based on the following mockup.

![Mockup for Togepi.Duke](assets/DukeMockup.png)
...
![Togepi.Duke's layout](assets/DukeSceneGraph.png)
...
![Togepi.Duke's raw layout](assets/RawLayout.png)
...
![Togepi.Duke's Final layout](assets/FinalLayout.png)
